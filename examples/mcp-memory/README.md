...
```sh
qilin web --patch "$PWD/examples/mcp-memory/memorix.cordis.yml"
```
...
qilin web --patch "$PWD/examples/mcp-memory/mcp-reference-memory.cordis.yml"
```
...
qilin web --patch "$PWD/examples/mcp-memory/engram.cordis.yml"
```
