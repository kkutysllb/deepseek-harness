 ...
 * the REAL `qilin-jsonrpc-agent` runtime (per `QILIN_EXAMPLE_MODE`) through the
 * REAL `@qilin/sdk-client`, drives one turn over stdio JSON-RPC,
...
import { DeepSeekHarness, type HarnessNotification, type RunResult } from '@qilin/sdk-client'
