...
| `ctx.clientModules` | `core` | [`client-modules`](../packages/client/modules) | - | [`client-hmr`](../packages/client/hmr) | - | Composes the __DSH_BOOT__ entry graph from an incremental qilin.client scan, serves plugin bundles, and notifies rebuilt/graph-changed subscribers. |
