...
packages/<group>/<pkg>/
  ...
  tsconfig.json    # extends ../../../tsconfig.base.json, rootDir src,
                   ...
                   # you use Config, + ../../<group>/<dep> for each openkylin dep)
...
A `packages/client/*` package additionally extends `tsconfig.base.client.json` instead of `tsconfig.base.json`, and a client plugin package declares `openkylin.client` in package.json, exports `./client`, and calls the shared tsdown preset (`packages/client/tsdown.client.ts`) — see [packages/client/AGENTS.md](../../packages/client/AGENTS.md) for the client-side contract.
