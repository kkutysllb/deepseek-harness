...
- The Web launcher publishes the canonical loopback URL and actual production/development mode in the logged `app:web-surface` prompt section and managed `$QILIN_WEB_URL`/`$QILIN_WEB_MODE` environment.
