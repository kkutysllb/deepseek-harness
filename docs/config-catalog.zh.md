...
依赖：[`agentCore`](../packages/examples/agent-spine-demo/src/index.ts) · [`JsonlCompression`](../packages/session/session-persistence-jsonl/src/index.ts) · [`ToolsConfig`](#qilintools)
...
export interface Config {
  /** Harness home containing the fixed user-global `AGENTS.md`; defaults to `$QILIN_HOME` or `~/.dsh`. */
  dshHome?: string
...
<a id="qilinagent-spine-demo"></a>

## `@qilin/agent-spine-demo`
...
依赖：[`AgentLoopConfig`](#qilinagent-loop) · [`GoalDomainConfig`](#qilingoal) · [`InvariantConfig`](#qilininvariants) · [`JobsConfig`](#qilinjobs-local) · [`SessionTitleConfig`](#qilinsession-title) · [`SkillFileSystem`](../packages/skill/skill-filesystem/src/index.ts) · [`SkillRegistryConfig`](#qilinskill) · [`SystemPromptConfig`](#qilinsystem-prompt) · [`toolBash`](../packages/shell/tool-bash/src/index.ts) · [`toolGoal`](../packages/goal/tool-goal/src/index.ts) · [`toolJobs`](../packages/jobs/tool-jobs/src/index.ts) · [`ToolsConfig`](#qilintools) · [`toolSkill`](../packages/skill/tool-skill/src/index.ts) · [`workspaceContext`](../packages/context/agent-instructions/src/index.ts)
...
export interface Config {
  /** Explicit harness home; omitted follows `QILIN_HOME`, then `~/.dsh`. */
  dshHome?: string
...
export interface ConnectionConfig {
   ...
   * by (the qilin CLI derives the machine's LAN IP literals itself). An entry
...
<a id="qilinsession-persistence-sqlite"></a>

## `@qilin/session-persistence-sqlite`
...
export interface Config {
  ...
  /**
   * Extra environment variables for the child process — e.g. the child
   * runtime's own `DEEPSEEK_API_KEY`, or `QILIN_CORDIS_CONFIG` naming its
...
- `@qilin/api-gateway` — 需要 `typert`（[`packages/api/gateway/src/index.ts`](../packages/api/gateway/src/index.ts)）
- `@qilin/api-remotes`（[`packages/api/remotes/src/index.ts`](../packages/api/remotes/src/index.ts)）
...
- `@qilin/client-runtime`（[`packages/client/runtime/src/index.ts`](../packages/client/runtime/src/index.ts)）
...
- `@qilin/client-ui-deliverables` — 需要 `systemPrompt`（[`packages/client/ui-deliverables/src/index.ts`](../packages/client/ui-deliverables/src/index.ts)）
...
- `@qilin/session-log-export` — 需要 `commands`（[`packages/session-query/session-log-export/src/index.ts`](../packages/session-query/session-log-export/src/index.ts)）
...
- `@qilin/acp-snapshot`（[`packages/test-support/acp-snapshot/src/index.ts`](../packages/test-support/acp-snapshot/src/index.ts)）
...
- `@qilin/code-runtime-python`（[`packages/code-runtime/code-runtime-python/src/index.ts`](../packages/code-runtime/code-runtime-python/src/index.ts)）
...
- `@qilin/sdk-jsonrpc-demo`（[`packages/examples/jsonrpc-demo/src/index.ts`](../packages/examples/jsonrpc-demo/src/index.ts)）
