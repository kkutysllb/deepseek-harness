...
import type { AgentContext } from '@qilin/client-runtime/client'
import type { Context } from '@deepseek-ai/cordis'
...
| Host | `@qilin/api-remotes` | Owns the application Agent/Session identity policy and configures the corresponding Typert lookups |
