...
Python subprocess SDK for driving DeepSeek Harness over newline-delimited JSON-RPC on stdio. Install `openkylin-sdk`; it installs the exact same-version `openkylin-runtime-bin` wheel for the current platform.
