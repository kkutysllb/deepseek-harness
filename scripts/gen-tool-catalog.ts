...
import type { SubagentProvider, SubagentReportDelivery } from '@qilin/subagent'
...
import * as ToolSubagentReport from '@qilin/tool-subagent-report'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@qilin/tool-subagent-report',
  ...
  },
  {
    ...
    scope: ctx => catalogChildScopes.get(ctx) as Agent,
    note:
      'All ten tools are scoped to implicit Team Leads and durable teammates. The shipped qilin-base bundle keeps the package disabled; the documented Agent Teams profile patch enables it while disabling the legacy continuable-child control names.',
  },
  {
    pkg: '@qilin/tool-todo',
    dir: 'tool-todo',
