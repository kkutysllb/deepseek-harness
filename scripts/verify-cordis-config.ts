 ...
 * silently changes composition. Example configs and the qilin Web composition
...
// These example files are overlays consumed by the built qilin app, so their bare
