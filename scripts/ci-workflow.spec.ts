...
describe('Python release workflows', () => {
  it('keeps complete wheel validation separate from protected public publication', () => {
    ...
    expect(pythonCompatSteps).toContain('dist/openkylin_sdk-$VERSION-py3-none-any.whl')
    expect(pythonCompatSteps).toContain('dist/openkylin_runtime_bin-$VERSION-py3-none-manylinux_2_28_x86_64.whl')
