...
OpenKylin is an all-plugin Cordis agent harness, forked and rebranded from DeepSeek Harness. Read [docs/architecture.md](docs/architecture.md) before changing `packages/`; follow [docs/AGENTS.md](docs/AGENTS.md) for documentation.
