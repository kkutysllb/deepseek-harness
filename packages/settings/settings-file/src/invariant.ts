/**
 * Package-owned invariant companion for `@qilin/settings-file`.
 * @module @qilin/settings-file/invariant
 */
...
const PACKAGE_NAME = '@qilin/settings-file'
 ...
 * tests; the in-process commit relation is owned by `@qilin/settings`.
 */
