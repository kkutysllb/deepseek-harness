/**
 * Package-owned invariant companion for `@qilin/session-query-sqlite`.
 * @module @qilin/session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-query-sqlite'
