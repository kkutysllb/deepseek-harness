/**
 * Package-owned invariant companion for `@qilin/client-ui-brand-official`.
 * @module @qilin/client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-brand-official'
