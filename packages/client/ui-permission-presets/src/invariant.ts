/**
 * Package-owned invariant companion for `@qilin/client-ui-permission-presets`.
 * @module @qilin/client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-permission-presets'
