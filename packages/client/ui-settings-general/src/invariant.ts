/**
 * Package-owned invariant companion for `@qilin/client-ui-settings-general`.
 * @module @qilin/client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-settings-general'
