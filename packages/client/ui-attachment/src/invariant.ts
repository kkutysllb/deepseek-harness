/**
 * Package-owned invariant companion for `@qilin/client-ui-attachment`.
 * @module @qilin/client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-attachment'
