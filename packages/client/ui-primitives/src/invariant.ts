/**
 * Package-owned invariant companion for `@qilin/client-ui-primitives`.
 * @module @qilin/client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-primitives'
