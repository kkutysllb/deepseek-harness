/**
 * Package-owned invariant companion for `@qilin/client-ui-conversation`.
 * @module @qilin/client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-conversation'
