...
import type { HostDescription } from '@qilin/client-connection/client'
import type {
  ChatConversationViewNode, ChatSnapshot, ConversationNode, RunningToolCall, SessionId,
} from '@qilin/client-runtime/client'
import type { SessionProviderComponent, TranslateNS } from '@qilin/client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@qilin/client-ui-conversation/src/client/contract/slots.ts'
