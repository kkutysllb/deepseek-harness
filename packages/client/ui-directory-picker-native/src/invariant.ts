/**
 * Package-owned invariant companion for `@qilin/client-ui-directory-picker-native`.
 * @module @qilin/client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-directory-picker-native'
