/**
 * Package-owned invariant companion for `@qilin/client-ui-directory-picker-browse`.
 * @module @qilin/client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-directory-picker-browse'
