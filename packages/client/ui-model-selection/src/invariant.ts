/**
 * Package-owned invariant companion for `@qilin/client-ui-model-selection`.
 * @module @qilin/client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-model-selection'
