/**
 * Package-owned invariant companion for `@qilin/client-ui-message-feedback`.
 * @module @qilin/client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-message-feedback'
