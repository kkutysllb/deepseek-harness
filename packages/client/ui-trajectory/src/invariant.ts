/**
 * Package-owned invariant companion for `@qilin/client-ui-trajectory`.
 * @module @qilin/client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-trajectory'
