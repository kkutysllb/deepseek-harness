...
None, as the package only renders the Host's account-administration HTTP surface inside browser settings views and never assembles a provider request, prompt section, or tool result.
