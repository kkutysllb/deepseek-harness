/**
 * Package-owned invariant companion for `@qilin/client-ui-settings-plugins`.
 * @module @qilin/client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-settings-plugins'
