/**
 * Package-owned invariant companion for `@qilin/client-ui-user-questions`.
 * @module @qilin/client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-user-questions'
