/**
 * Package-owned invariant companion for `@qilin/client-ui-deliverables`.
 * @module @qilin/client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-deliverables'
