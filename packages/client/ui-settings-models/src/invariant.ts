/**
 * Package-owned invariant companion for `@qilin/client-ui-settings-models`.
 * @module @qilin/client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-settings-models'
