...
import type { JobView } from '@qilin/client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@qilin/client-ui-primitives'
