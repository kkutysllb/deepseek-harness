...
export { AbstractApiClient } from '@qilin/host-apiproxy/client'
export type { IApiClient } from '@qilin/host-apiproxy/client'
...
export type HostDescription = import('@qilin/host-apiproxy/api').ResponseValue<'host.describe'>

import type { RpcResponse, RpcResult } from '@qilin/host-apiproxy/api'
