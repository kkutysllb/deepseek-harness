...
import { ConversationNodeAssembler } from '@qilin/client-runtime/client'
...
import { commandDefinition } from '@qilin/client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@qilin/client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
