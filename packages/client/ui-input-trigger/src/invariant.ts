/**
 * Package-owned invariant companion for `@qilin/client-ui-input-trigger`.
 * @module @qilin/client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-input-trigger'
