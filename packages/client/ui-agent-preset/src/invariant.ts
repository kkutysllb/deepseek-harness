/**
 * Package-owned invariant companion for `@qilin/client-ui-agent-preset`.
 * @module @qilin/client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@qilin/client-ui-agent-preset'
