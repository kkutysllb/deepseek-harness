/**
 * Package-owned invariant companion for `@qilin/compaction-tool-result-pruner`.
 * @module @qilin/compaction-tool-result-pruner/invariant
 */
...
const PACKAGE_NAME = '@qilin/compaction-tool-result-pruner'
