/**
 * Package-owned invariant companion for `@qilin/session-checkpoint-policy`.
 * @module @qilin/session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-checkpoint-policy'
