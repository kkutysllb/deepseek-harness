/**
 * Package-owned invariant companion for `@qilin/session-turn-outline`.
 * @module @qilin/session-turn-outline/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-turn-outline'
 ...
 * qilin-agent-loop and the session surface, not here.
 */
