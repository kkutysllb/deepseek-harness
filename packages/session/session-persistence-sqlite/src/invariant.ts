/**
 * Package-owned invariant companion for `@qilin/session-persistence-sqlite`.
 * @module @qilin/session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-persistence-sqlite'
