/**
 * Package-owned invariant companion for `@qilin/session-telemetry-otel`.
 * @module @qilin/session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-telemetry-otel'
