/**
 * Package-owned invariant companion for `@qilin/session-title-all-prompts-llm`.
 * @module @qilin/session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-title-all-prompts-llm'
