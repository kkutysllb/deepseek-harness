/**
 * Package-owned invariant companion for `@qilin/session-title-first-prompt-llm`.
 * @module @qilin/session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-title-first-prompt-llm'
