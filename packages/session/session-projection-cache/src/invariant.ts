/**
 * Package-owned invariant companion for `@qilin/session-projection-cache`.
 * @module @qilin/session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-projection-cache'
