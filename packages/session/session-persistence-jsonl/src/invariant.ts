/**
 * Package-owned invariant companion for `@qilin/session-persistence-jsonl`.
 * @module @qilin/session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@qilin/session-persistence-jsonl'
