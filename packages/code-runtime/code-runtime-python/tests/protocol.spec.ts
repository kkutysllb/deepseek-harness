...
describe('logTruncationMarker', () => {
  it('names the configured byte budget', () => {
    expect(logTruncationMarker(65536)).toBe('[qilin-code-runtime-python] log capture truncated at 65536 bytes')
    expect(logTruncationMarker(1)).toBe('[qilin-code-runtime-python] log capture truncated at 1 bytes')
  })
})
