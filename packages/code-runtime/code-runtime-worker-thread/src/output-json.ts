/** JSON string-prefix accounting for the outer-output ledger. @module @qilin/code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@qilin/code-runtime'
