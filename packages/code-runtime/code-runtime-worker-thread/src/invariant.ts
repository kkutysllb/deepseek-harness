/**
 * Package-owned invariant companion for `@qilin/code-runtime-worker-thread`.
 * @module @qilin/code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@qilin/code-runtime-worker-thread'
