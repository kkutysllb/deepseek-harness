...
import type { ApprovalRequestId } from '@qilin/user-approval'
import type { ApiProxy, MuxFrame, RpcRequest } from '@qilin/host-apiproxy/api'
import type { RpcId } from '@qilin/host-apiproxy/api/rpc'
import { RpcId as mintRpcId } from '@qilin/host-apiproxy/api/rpc'
