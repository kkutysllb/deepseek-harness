/** Package-owned invariant companion for the directory-picker seam. @module @qilin/host-directory-picker/invariant */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@qilin/invariants'

const PACKAGE_NAME = '@qilin/host-directory-picker'
