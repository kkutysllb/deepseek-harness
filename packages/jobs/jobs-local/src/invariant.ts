/**
 * Package-owned invariant companion for `@qilin/jobs-local`.
 * @module @qilin/jobs-local/invariant
 */
...
const PACKAGE_NAME = '@qilin/jobs-local'
...
/**
 * No runtime invariant: `@qilin/jobs/invariant` owns per-snapshot identity, status,
