/**
 * Package-owned invariant companion for `@qilin/cordis-client-runner`.
 * @module @qilin/cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@qilin/cordis-client-runner'
