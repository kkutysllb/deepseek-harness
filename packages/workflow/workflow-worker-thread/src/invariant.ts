/**
 * Package-owned invariant companion for `@qilin/workflow-worker-thread`.
 * @module @qilin/workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@qilin/workflow-worker-thread'
