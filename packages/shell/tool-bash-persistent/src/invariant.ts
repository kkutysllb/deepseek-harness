/**
 * Package-owned invariant companion for `@qilin/tool-bash-persistent`.
 * @module @qilin/tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-bash-persistent'
