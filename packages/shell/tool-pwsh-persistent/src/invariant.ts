/**
 * Package-owned invariant companion for `@qilin/tool-pwsh-persistent`.
 * @module @qilin/tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-pwsh-persistent'
