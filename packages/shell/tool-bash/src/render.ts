 ...
 *
 * @module @qilin/tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@qilin/shell'
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@qilin/shell'
