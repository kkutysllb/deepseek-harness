/**
 * Package-owned invariant companion for `@qilin/experimental-webworker-runtime`.
 * @module @qilin/experimental-webworker-runtime/invariant
 */
...
const PACKAGE_NAME = '@qilin/experimental-webworker-runtime'
