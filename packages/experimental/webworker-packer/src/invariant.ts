/**
 * Package-owned invariant companion for `@qilin/experimental-webworker-packer`.
 * @module @qilin/experimental-webworker-packer/invariant
 */
...
const PACKAGE_NAME = '@qilin/experimental-webworker-packer'
