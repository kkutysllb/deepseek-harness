#!/usr/bin/env node
/**
 * Stable link target for the `qilin-pack-vfs-image` bin, forwarding to the build
 * product.
 *
...
if (!existsSync(fileURLToPath(entry))) {
  process.stderr.write('qilin-pack-vfs-image: lib/bin.js is missing — run `pnpm run build` before packing an image\n')
  process.exit(1)
}
