...
| `qilin-agent-presets`, `qilin-session-title`, `qilin-plan-mode`, `qilin-schedule`, `qilin-webserver` | Preset mount placement, title source citation, plan-mode payload, schedule stream, route disposer symmetry |
