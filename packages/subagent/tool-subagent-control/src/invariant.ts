/**
 * Package-owned invariant companion for `@qilin/tool-subagent-control`.
 * @module @qilin/tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-subagent-control'
