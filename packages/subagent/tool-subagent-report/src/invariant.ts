/**
 * Package-owned invariant companion for `@qilin/tool-subagent-report`.
 * @module @qilin/tool-subagent-report/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-subagent-report'
