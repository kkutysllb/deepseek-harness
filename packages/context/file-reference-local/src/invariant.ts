/**
 * Package-owned invariant companion for `@qilin/file-reference-local`.
 * @module @qilin/file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@qilin/file-reference-local'
