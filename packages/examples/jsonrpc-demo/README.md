...
- **No built-in or default config exists** — every launch must provide `QILIN_CORDIS_CONFIG` or a positional path, and deployment owns the complete plugin tree and stdout discipline.
