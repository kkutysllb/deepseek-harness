 ...
 * ({@link @qilin/agent-spine-demo}), JSONL session persistence, and
 * the {@link @qilin/acp} bridge. The app owns those plugins through one
 ...
 * @module @qilin/acp-demo
 */

import type { Context } from '@deepseek-ai/cordis'
import { join } from 'node:path'
import z from '@deepseek-ai/schemastery'
import * as acp from '@qilin/acp'
import * as agentCore from '@qilin/agent-spine-demo'
...
} from '@qilin/session-persistence-jsonl'
