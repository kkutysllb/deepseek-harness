...
import SessionTitleService, { type Config as SessionTitleConfig } from '@qilin/session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@qilin/system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@qilin/tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@qilin/skill'
import * as SkillFileSystem from '@qilin/skill-filesystem'
import AgentRegistry from '@qilin/agent'
import GoalService, { type Config as GoalDomainConfig } from '@qilin/goal'
import * as goalSession from '@qilin/goal-round-driver'
import * as toolGoal from '@qilin/tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@qilin/jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@qilin/invariants'
...
import * as bashEnv from '@qilin/shell-env'
...
import AgentLoop, { type Config as AgentLoopConfig } from '@qilin/agent-loop'
