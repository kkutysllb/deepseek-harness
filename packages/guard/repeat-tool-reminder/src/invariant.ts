/**
 * Package-owned invariant companion for `@qilin/repeat-tool-reminder`.
 * @module @qilin/repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@qilin/repeat-tool-reminder'
