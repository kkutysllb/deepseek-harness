/**
 * Package-owned invariant companion for `@qilin/tool-call-timeout-policy`.
 * @module @qilin/tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-call-timeout-policy'
