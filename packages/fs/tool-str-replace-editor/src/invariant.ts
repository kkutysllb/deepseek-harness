/**
 * Package-owned invariant companion for `@qilin/tool-str-replace-editor`.
 * @module @qilin/tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@qilin/tool-str-replace-editor'
